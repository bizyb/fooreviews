...
class ProductTaxonomy(MPTTModel, models.Model):
    ...
    def save(self, *args, **kwargs):
        # update fields only if object is newly created; if object is
        # loaded from db transfer, the fields should already be populated
        ...
        super(ProductTaxonomy, self).save(*args, **kwargs)
